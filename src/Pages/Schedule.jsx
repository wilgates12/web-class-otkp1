...
const Schedule = () => {
  ...
  if (currentWeek === 2 || currentWeek === 4) {
    piketGroup = [
      ["Asep", "Wildan", "Lusi", "Damar", "Rizky", "Sri"],
      ["Salwa", "Agil", "Alendra", "Andini", "Rivandi", "Shaffana"],
      ["Andri", "Ayu", "Dimas", "Ilham", "Lara", "Restu", "Vera"],
      ["Lestari", "Fikri", "Dani", "Ken", "Ridho", "Ranggita"],
      ["Jumat Bersih!"],
      ["Maulida", "Melisa", "Nadila", "Nasrul", "Aisyah", "Apiw"],
    ];
